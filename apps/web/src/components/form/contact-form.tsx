	...
	return (
		...
		>
			...
			<Dialog.Root open={!!image} onOpenChange={onDialogClose}>
				<Dialog.Portal>
					<Dialog.Overlay>
						<Dialog.Content className="text-center lg:h-fit">
							<div className="flex flex-col justify-center gap-lg">
								...
								<Dialog.Description className="-mt-md flex flex-col">
									<span>Below you can see the card that was sent.</span>
									<span>It's <span className="text-ok-500">digitally signed</span> so you can prove it was generated by this website!</span>
									<span>Click the button below to download it to your device.</span>
								</Dialog.Description>

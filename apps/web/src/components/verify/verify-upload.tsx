...
export const VerifyUpload: FunctionComponent = () => {
	...
	const className: DropzoneProps["className"] = ({ isDropTarget }) => clsx(
		"box-content flex aspect-video flex-col justify-center gap-lg border-[3px] p-lg transition-colors",
		{
			...
			"bg-ok-500/25 dark:border-ok-500 border-ok-800": isValid,
		...
		<>
			...
			{isValid !== null ? (
				<p className={clsx(
					...
					{
						"bg-ok-500/25 dark:text-ok-300 dark:border-ok-500 text-ok-800 border-ok-800": isValid,
						"bg-error-600/25 dark:text-error-300 border-error-600 text-red-800": !isValid
					}
				)}>
